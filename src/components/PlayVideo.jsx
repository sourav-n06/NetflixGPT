...
const { id } = useParams();
  ...
  return (
    <div>
        <div className="px-12 bg-gradient-to-b from-neutral-900 md:bg-gradient-to-b from-neutral-900 sm:16 md:px-20 lg:px-20 py-2 flex justify-between absolute w-screen">
        <img className="hidden sm:inline-block md:inline-block sm:w-32 md:w-32 lg:w-32 " src= {NetflixImage} alt="logo"/>
        <img className=" w-5 inline-block sm:hidden  md:hidden " src= "https://upload.wikimedia.org/wikipedia/commons/0/0c/Netflix_2015_N_logo.svg"/>
